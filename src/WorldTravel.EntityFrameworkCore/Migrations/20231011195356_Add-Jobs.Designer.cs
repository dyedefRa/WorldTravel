...
namespace WorldTravel.Migrations
{
    ...
    [Migration("20231011195356_Add-Jobs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorldTravel.Entities.Cities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Countries.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.CountryContentFiles.CountryContentFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CountryContentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "FileId" }, "IX_AppCountryContentFile_FileId");

                    b.ToTable("AppCountryContentFiles");
                });
            ...
            modelBuilder.Entity("WorldTravel.Entities.Files.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Forms.Form", b =>
                {
                    ...
                    b.HasIndex(new[] { "CountryId" }, "IX_AppForm_CountryId");

                    b.ToTable("AppForms");
                });

            modelBuilder.Entity("WorldTravel.Entities.Jobs.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "CountryId" }, "IX_AppJob_CountryId");

                    b.HasIndex(new[] { "ImageId" }, "IX_AppJob_FileId");

                    b.ToTable("AppJobs");
                });

            modelBuilder.Entity("WorldTravel.Entities.Logs.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.MailTemplates.MailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MailTemplateValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorldTravel.Entities.SentMails.SentMail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.VisaTypes.VisaType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "CountryId" }, "IX_AppVisaType_CountryId");

                    b.HasIndex(new[] { "ImageId" }, "IX_AppVisaType_FileId");

                    b.ToTable("AppVisaTypes");
                });
            ...
            modelBuilder.Entity("WorldTravel.Entities.CountryContentFiles.CountryContentFile", b =>
                {
                    b.HasOne("WorldTravel.Entities.CountryContents.CountryContent", "CountryContent")
                        .WithMany("CountryContentFiles")
                        .HasForeignKey("CountryContentId")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Towns.Town", b =>
                {
                    b.HasOne("WorldTravel.Entities.Cities.City", "City")
                        .WithMany("Towns")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Users.AppUser", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("WorldTravel.Entities.Users.AppUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorldTravel.Entities.Files.File", "Image")
                        .WithOne("User")
                        .HasForeignKey("WorldTravel.Entities.Users.AppUser", "ImageId");
